...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the account input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the account about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    account to let them know what the print view is.
	...
	/**
	 * Show a message to the end account which is nicely styled
	 *  @param {string} message The HTML string to show to the account
	...
	/**
	 * Take the account defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the account options */
		...
		// Backwards compatibility - allow the account to specify a custom class in the initialiser
	...
	/**
	 * Take the account input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of account defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end account but it allows the animation to be
		...
		if ( this.s.master )
		{
			...
			if ( this.s.select.type === 'os' ) {
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-account-select', '' );
				} );
			}
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the account know what is happening */
		if ( oConfig.sInfo !== "" )
		{
