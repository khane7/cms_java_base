...
<script src="${ pageContext.request.contextPath }/bootstrap/assets/js/jquery-ui.custom.min.js"></script>
<script src="${ pageContext.request.contextPath }/bootstrap/assets/js/jquery.ui.touch-punch.min.js"></script>
<script src="${ pageContext.request.contextPath }/bootstrap/assets/js/markdown/markdown.min.js"></script>
<script src="${ pageContext.request.contextPath }/bootstrap/assets/js/markdown/bootstrap-markdown.min.js"></script>
<script src="${ pageContext.request.contextPath }/bootstrap/assets/js/jquery.hotkeys.min.js"></script>
<script src="${ pageContext.request.contextPath }/bootstrap/assets/js/bootstrap-wysiwyg.min.js"></script>
...
//but we want to change a few buttons colors for the third style
		...
		$(window).on('resize.editor', function () {
			...
			$('#editor').css({'height': winHeight - offset.top - 300, 'max-height': 'none'});
...
//another option would be opening a dialog for account to enter dimensions.
	...
	$.getScript($path_assets+"${ pageContext.request.contextPath }/bootstrap/js/jquery-ui.custom.min.js", function(data, textStatus, jqxhr) {
		enableImageResize()
	});
}
			 */
