						...
						<div class="widget-box">
							...
							<div class="widget-body">
								<div class="widget-main">
									...
									<div class="form-group">
										<label class="col-sm-1 control-label no-padding-right" for="opt2"> 외부링크 </label>
										<div class="col-sm-9">
											<input class="col-xs-10 col-sm-10" id="opt2" name="opt2" type="text" placeholder="외부링크를 입력해주세요. 작성시 게시물이 링크로 연결됩니다.">
										</div>
									</div>
