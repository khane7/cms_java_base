...
<form id="frm-uploader" name="frm-uploader">
...
<div class="page-content">
	<div class="row">
		...
		<div class="center" style="width:95%; margin:12px;">
...
<script type="text/javascript">
	...
	$('#id-input-file').ace_file_input({
		...
		if ("FormData" in window) {
			...
			deferred = $.ajax({
				url: "${pageContext.request.contextPath}/cms_manager/file/upload",
				type: "post",
	...
	var deleteFile = function (idx) {
		getProcess4Front("${pageContext.request.contextPath}/cms_manager/file/deleteFile", {"idx": idx}, function(data) {
	...
	var getFileList4tb = function () {
		...
		if ( getParameter("tb_name") != "" && getParameter("idx") != "") {
			...
			var objResult = getProcess4Front("${pageContext.request.contextPath}/cms_manager/file/getFileList", {
	...
	var getFileList4Idx = function () {
		...
		getProcess4Front("${pageContext.request.contextPath}/cms_manager/file/getFiles", {"file_idxs": file_idxs}, function(data) {
			if ( data.status == "OK" ) {
